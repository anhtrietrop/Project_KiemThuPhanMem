...
const SortBy = () => {
  ...
  return (
    <div className="flex items-center gap-x-5 max-lg:flex-col max-lg:w-full max-lg:items-start">
      <h3 className="text-xl">{t('sortBy')}</h3>
      <select
        defaultValue={sortBy}
        ...
        name="sort"
      >
        <option value="defaultSort">{t('defaultSort')}</option>
        <option value="titleAsc">{t('sortAZ')}</option>
        <option value="titleDesc">{t('sortZA')}</option>
        <option value="lowPrice">{t('lowestPrice')}</option>
        <option value="highPrice">{t('highestPrice')}</option>
      </select>
    </div>
  );
};
