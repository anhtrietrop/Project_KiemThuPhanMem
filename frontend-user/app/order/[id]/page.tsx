      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p>
                ...
                <span
                  className={`ml-2 px-3 py-1 rounded-full text-white text-sm ${getStatusColor(
                    order?.status
                  )}`}
                >
              ...
              <p className="mt-2">
                ...
                <span
                  className={`ml-2 px-3 py-1 rounded-md text-xs font-semibold border ${getPaymentStatusColor(
            ...
            <div>
              ...
              <p>
                <strong>Địa chỉ:</strong> {order?.adress}
              </p>
              {order?.apartment && (
                <p>
                  <strong>Căn hộ:</strong> {order.apartment}
                </p>
              )}
              <p>
              ...
              {order?.orderNotice && (
                <p>
                  <strong>Ghi chú:</strong> {order.orderNotice}
                </p>
              )}
            </div>
          </div>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600">
                    Giá: {formatCurrencyVND(product?.product?.price)}
                  </p>
        ...
        <div className="bg-gray-50 p-6 rounded-lg mb-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between font-bold text-lg">
              <span>Tổng cộng:</span>
              <span>
                {formatCurrencyVND(order?.total + order?.total / 5 + 5000)}
              </span>
            </div>
          </div>
        </div>
        ...
        {order?.status === "cancelled" && (
          <div className="text-center bg-red-50 p-6 rounded-lg">
            ...
            {order?.cancelReason && (
              <p className="text-gray-600">Lý do hủy: {order.cancelReason}</p>
            )}
          </div>
        )}
      </div>
