...
import {
  ValidationTooltip,
  VALIDATION_RULES,
} from "@/components/ValidationTooltip";
  ...
  const makePurchase = async () => {
    ...
    try {
      ...
      const orderData = {
        ...
        status: "processing", // Đơn hàng mới tạo sẽ ở trạng thái processing
        total: total,
      ...
      if (!response.ok) {
        ...
        try {
          ...
          if (response.status === 409) {
            ...
            toast.error(
              errorData.details || errorData.error || "Duplicate order detected"
            );
